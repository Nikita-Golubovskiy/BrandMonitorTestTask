...
namespace PresentationLayer.BrandMonitorTestTask.Cqrs.Assets.Strings.Errors {
    ...
    internal class Common {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Задача с данным идентификатором уже существует в системе..
        /// </summary>
        internal static string TASK_ID_ALREADY_IN_USE {
            get {
                return ResourceManager.GetString("TASK_ID_ALREADY_IN_USE", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Задачи с заданым идентификатором не найдено в системе..
        /// </summary>
